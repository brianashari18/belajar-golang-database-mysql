...
func TestExecSql(t *testing.T) {
	...
	script := "INSERT INTO customer(id, name) VALUES('puyol', 'Puyol')"
...
func TestInjectionSql(t *testing.T) {
	db := GetConnection()
	defer db.Close()
...
func TestInjectionSqlSafe(t *testing.T) {
	db := GetConnection()
	defer db.Close()
...
func TestPrepareStatement(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		email := "brian" + strconv.Itoa(i) + "@gmail.com"
